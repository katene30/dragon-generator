  ...
  return knex('dragons').del()
    .then(function () {
      ...
      return knex('dragons').insert([
        {id: 1, Gender: 'male', image: 'images/image1', firstName: 'Puff', lastName: 'the magic dragon'},
        {id: 2, Gender: 'male', image: 'images/image2', firstName: 'Toothless', lastName: 'the toothless'},
        {id: 3, Gender: 'male', image: 'images/image3', firstName: 'Smaug', lastName: 'destroyer of worlds'},
